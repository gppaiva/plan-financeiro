...
export function InvestmentsPage() {
  ...
  const bankIcon = <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--text2)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
  const typeIcon = <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--text2)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
    ...
    <PageContainer>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, padding: '16px 20px' }}>
        ...
        {loading ? (
          ...
          <p style={{ padding: '32px 0', textAlign: 'center', fontSize: 14, color: 'var(--text2)' }}>Nenhum investimento cadastrado</p>
        ) : (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {accounts.map((account) => (
              <div
                ...
                style={{ background: 'var(--card-bg)', borderRadius: 16, border: '1px solid var(--border)', padding: 16, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{ width: 40, height: 40, borderRadius: '50%', background: 'var(--bg2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  ...
                  <div>
                    <p style={{ fontSize: 14, fontWeight: 500, color: 'var(--text)', margin: 0 }}>{account.nome}</p>
                    <p style={{ fontSize: 12, color: 'var(--text2)', margin: '2px 0 0' }}>{account.tipo}</p>
                  </div>
                </div>
