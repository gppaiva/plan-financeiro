    ...
    <div style={{ minHeight: '100dvh', background: 'var(--bg)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{ flex: 1, width: '100%', maxWidth: 430, background: 'var(--card-bg)', borderRadius: '28px 28px 0 0', padding: '28px 24px 40px', boxShadow: '0 -4px 30px rgba(0,0,0,0.06)', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '24px 0' }}>
          ...
          <span style={{ fontSize: 13, color: 'var(--text2)' }}>ou</span>
          <div style={{ flex: 1, height: 1, background: 'var(--border)' }} />
        </div>

        {/* Google */}
        <button type="button" onClick={handleGoogle} style={{ width: '100%', padding: '14px 0', borderRadius: 14, border: '1.5px solid var(--border)', background: 'var(--card-bg)', fontSize: 15, fontWeight: 500, color: 'var(--text)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
